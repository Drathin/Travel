...
public class BannerDaoImpl implements BannerDao{
	...
	public List<Banner> findAllBanner(Map<String, Object> map) {
		// TODO Auto-generated method stub
				...
				try {
					...
					Banner banar = new Banner();
					banar.setBannerid(rs.getInt("banarid"));
	...
	@Override
	public int updateBanner(Banner banar) {
		// TODO Auto-generated method stub
		return 0;
	}
	
	@Override
	public int deleteBanner(Banner banar) {
		// TODO Auto-generated method stub
		//声明变量，用于保存查询结果
				int result = 0;
				//声明预编译的声明对象变量，用于进行数据库操作的载体
	...
	@Override
	public Banner findOneBanner(Banner banar) {
		// TODO Auto-generated method stub
		return null;
	}
